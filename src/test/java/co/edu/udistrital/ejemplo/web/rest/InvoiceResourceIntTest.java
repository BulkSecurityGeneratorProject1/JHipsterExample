...
public class InvoiceResourceIntTest {
    ...
    private static final Long DEFAULT_ITEM_COUNT = 1L;
    private static final Long UPDATED_ITEM_COUNT = 2L;
    ...
    public void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getItemCount()).isEqualTo(DEFAULT_ITEM_COUNT);
    ...
    public void getAllInvoices() throws Exception {
        ...
        restInvoiceMockMvc.perform(get("/api/invoices?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].itemCount").value(hasItem(DEFAULT_ITEM_COUNT.intValue())))
    ...
    public void getInvoice() throws Exception {
        ...
        restInvoiceMockMvc.perform(get("/api/invoices/{id}", invoice.getId()))
            ...
            .andExpect(jsonPath("$.itemCount").value(DEFAULT_ITEM_COUNT.intValue()))
    ...
    public void updateInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getItemCount()).isEqualTo(UPDATED_ITEM_COUNT);
